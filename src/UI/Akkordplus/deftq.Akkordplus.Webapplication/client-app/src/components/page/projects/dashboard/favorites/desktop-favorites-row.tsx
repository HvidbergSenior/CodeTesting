...
import { GetProjectResponse, FavoritesResponse } from "api/generatedApi";
...
export const DesktopFavoriteRow = (props: Props) => {
  ...
  return (
    <TableRow data-testid={`dashboard-favorite-row-${row.text}`}>
      ...
      {/* KTH 14/4-23 hide until we have units <TableCell data-testid="dashboard-favorite-row-unit">{row.unit}</TableCell> */}
    </TableRow>
  );
};
