...
export const DesktopWorkItemOperationTableRow = (props: Prop) => {
  ...
  return (
    <TableRow data-testid={`measurements-operation-table-row-${workItem.workItemText}`} sx={{ cursor: "pointer" }}>
      <TableCell>
        <Checkbox
          data-testid="measurement-table-row-operation-checkbox"
      ...
      <TableCell
        ...
        data-testid="measurements-table-cell-operation"
        title={workItem.workItemText ?? ""}
        onClick={showWorkItemInfo}
      >
        {workItem.workItemText}
      </TableCell>
      <TableCell sx={{ color: "primary.main" }} data-testid="measurements-table-cell-moutingcode" onClick={showWorkItemInfo}></TableCell>
